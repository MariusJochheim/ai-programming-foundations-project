...
% Editable metadata
% -----------------------------------------------------------------------------
\newcommand{\ThesisTitle}{Your Full Thesis Title Goes Here}
\newcommand{\AuthorName}{Your Name Here}
\newcommand{\Institution}{Your University}
\newcommand{\CourseName}{Course Name \& Number}
\newcommand{\SupervisorName}{Instructor or Supervisor}
\newcommand{\SubmissionDate}{Due Date}
